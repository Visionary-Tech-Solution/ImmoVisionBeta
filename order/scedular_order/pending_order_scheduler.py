...
def start():
    ...
    scheduler.add_job(pending_order_assign, "interval", minutes=10, id="pending_order__001", replace_existing=True)
    scheduler.add_job(order_waiting, "interval", minutes=10, id="waiting_order__001", replace_existing=True)
